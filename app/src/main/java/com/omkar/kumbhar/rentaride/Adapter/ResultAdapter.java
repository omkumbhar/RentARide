...
public class ResultAdapter extends RecyclerView.Adapter<ResultAdapter.MyViewHolder> {
    ...
    public ResultAdapter(List<ResultModel> result, Context mContext, String vehicle) {
        this.result = result;
    ...
    public void onBindViewHolder(@NonNull ResultAdapter.MyViewHolder myViewHolder, int i) {
        ...
        String seater = myViewHolder.ResultSeater.getText()+ " : "+ resultModel.getSeater();
        String rent =    myViewHolder.ResultPrice.getText() + resultModel.getRent();
        String fuel = myViewHolder.ResultFuelType.getText()+ " : " + resultModel.getFuleType();

        String distance = myViewHolder.ResultDistance.getText()+ " : " + getDistance(4,5);
